...
namespace WpfExcelLPA.pt.europeia.elpusonline {
    using System;
    ...
    public partial class WebSapi : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public WebSapi() {
            this.Url = global::WpfExcelLPA.Properties.Settings.Default.WpfExcelLPA_pt_europeia_elpusonline_WebSapi;
        ...
        public string StreamPut(string nomeFunc, int nivelComp, string certificado, string formatoOutput, string pEntrada, string pSaida, object bytesEntrada) {
        ...
        /// <remarks/>
        public void StreamPutAsync(string nomeFunc, int nivelComp, string certificado, string formatoOutput, string pEntrada, string pSaida, object bytesEntrada) {
            this.StreamPutAsync(nomeFunc, nivelComp, certificado, formatoOutput, pEntrada, pSaida, bytesEntrada, null);
        }
        
        /// <remarks/>
        public void StreamPutAsync(string nomeFunc, int nivelComp, string certificado, string formatoOutput, string pEntrada, string pSaida, object bytesEntrada, object userState) {
